...
fbd_path = make_fbd(str(FIG_DIR / "fbd_governing_integrated.png"))
xs_path = make_cross_section(str(FIG_DIR / "cross_section_integrated.png"))
sm_path = make_shear_moment(str(FIG_DIR / "shear_moment_integrated.png"))
...
PDF_PATH = str(PDF_DIR / "Appendix_C_Integrated.pdf")
