# SolidWorks Build Guide — Design B
## NAU ASCE Concrete Canoe 2026
*Design B — Conservative (Extra Margin)*
*Dimensions: 196" × 34" × 18", Shell: 0.5"*
*Target weight: 242.7 lbs*
...
2. **Tools → Options → Document Properties → Units**
   ...
   - Length decimals: 3
3. Save as `CanoeHull_DesignB.SLDPRT`
...
### Station at 49" — Forward Quarter
- **Plane:** Offset 49" from bow reference
- **Beam at waterline:** 24.0"
- **Deadrise angle:** 15°

| Point | X (in) | Y (in) | Description |
|-------|-------:|-------:|-------------|
| 1 | -12.02 | 18.00 | Port gunwale |
| 2 | -12.02 | 3.22 | Port chine |
| 3 | 0.00 | 0.00 | Keel (centerline) |
| 4 | 12.02 | 3.22 | Starboard chine |
| 5 | 12.02 | 18.00 | Starboard gunwale |

**Sketch:** Connect points 1→2→3→4→5 with lines. Add fillets (R=0.5") at chine points 2 and 4.


### Station at 98" — Midship
- **Plane:** Offset 98" from bow reference
- **Beam at waterline:** 34.0"
- **Deadrise angle:** 15°

| Point | X (in) | Y (in) | Description |
|-------|-------:|-------:|-------------|
| 1 | -17.00 | 18.00 | Port gunwale |
| 2 | -17.00 | 4.56 | Port chine |
| 3 | 0.00 | 0.00 | Keel (centerline) |
| 4 | 17.00 | 4.56 | Starboard chine |
| 5 | 17.00 | 18.00 | Starboard gunwale |

**Sketch:** Connect points 1→2→3→4→5 with lines. Add fillets (R=0.5") at chine points 2 and 4.


### Station at 147" — Aft Quarter
- **Plane:** Offset 147" from bow reference
- **Beam at waterline:** 24.0"
- **Deadrise angle:** 15°
...
### Station at 196" — Stern
- **Plane:** Offset 196" from bow reference
- **Shape:** Point (hull converges to keel)
- **Coordinates:** (0, 0) — single point at keel
...
2. Draw a spline from (0, 0) to (196, 0) with rocker:
...
3. Expected values:
   - **Volume:** ~6990 in³
   - **Mass:** ~243 lbs (concrete only)
   - Add 17 lbs for reinforcement/hardware = **243 lbs total**
...
See: `design/dxf_coords_design_B.txt` for all station coordinates
at 6" spacing (33 stations total).
